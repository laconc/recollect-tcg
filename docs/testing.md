...
| DB integration | `recollect-journal-postgres` | `#[ignore = "requires postgres"]`; run `make up && make db-test`. Accounts, token hashing, seq conflicts, draws_after. |
...
- **What it covers.** The play page + picker (the three tellings, the
